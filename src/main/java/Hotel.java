...
class Hotel {
    ...
    static void CustDetails(int i, int rn) {
        ...
        switch (i) {
            case 1:
                hotel_ob.luxury_doubleroom[rn] = new DoubleLuxuryRoom();
                hotel_ob.luxury_doubleroom[rn].setDoubleRoomDetails(name, contact, gender, name2, contact2, gender2);
                break;
            case 2:
                hotel_ob.deluxe_doubleroom[rn] = new DoubleDeluxeRoom();
                hotel_ob.deluxe_doubleroom[rn].setDoubleRoomDetails(name, contact, gender, name2, contact2, gender2);
                break;
            case 3:
                hotel_ob.luxury_singleroom[rn] = new SingleLuxuryRoom();
                hotel_ob.luxury_singleroom[rn].setSingleRoomDetails(name, contact, gender);
                break;
            case 4:
                hotel_ob.deluxe_singleroom[rn] = new SingleDeluxeRoom();
                hotel_ob.deluxe_singleroom[rn].setSingleRoomDetails(name, contact, gender);
                break;
            default:
    ...
    static String features(int i) {
        ...
        switch (i) {
            case 1:
                ...
                Message="Number of double beds : 1\nAC : Yes\nFree breakfast : Yes\nCharge per day:4000 ";
                break;
            case 2:
                System.out.println("Number of double beds : 1\nAC : No\nFree breakfast : Yes\nCharge per day:3000  ");
                Message="Number of double beds : 1\nAC : No\nFree breakfast : Yes\nCharge per day:3000  ";
            ...
            case 3:
                ...
                Message="Number of single beds : 1\nAC : Yes\nFree breakfast : Yes\nCharge per day:2200  ";
                break;
            case 4:
                System.out.println("Number of single beds : 1\nAC : No\nFree breakfast : Yes\nCharge per day:1200 ");
                Message="Number of single beds : 1\nAC : No\nFree breakfast : Yes\nCharge per day:1200 ";
        ...
        switch (rtype) {
            case 1:
                ...
                for (Food obb : hotel_ob.luxury_doubleroom[rn].food) {
                    amount += obb.calculatePrice();
                    String format = "%-10s%-10s%-10s%n";
                    System.out.printf(format, list[obb.itemNo - 1], obb.quantity, obb.calculatePrice());
                }
    ...
    static void deallocate(int rn, int rtype) {
        ...
        switch (rtype) {
            case 1:
                if (hotel_ob.luxury_doubleroom[rn] != null)
                    System.out.println("Room used by " + hotel_ob.luxury_doubleroom[rn].name1);
                else {
            ...
            case 2:
                if (hotel_ob.deluxe_doubleroom[rn] != null)
                    System.out.println("Room used by " + hotel_ob.deluxe_doubleroom[rn].name1);
                else {
                    System.out.println("Empty Already");
    ...
    static String order(int rn, int rtype) {
        int i, q;
        char wish;
        try {
            System.out.println("\n==========\n   Menu:  \n==========\n\n1.Sandwich\tRs.50\n2.Pasta\t\tRs.60\n3.Noodles\tRs.70\n4.Coke\t\tRs.30\n");
        ...
        return "Do you want to order anything else ? (y/n)";
    }
}
